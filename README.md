...
Total number of images: 103539.

Training set size: 77568 images (one fruit or vegetable per image).

Test set size: 25971 images (one fruit or vegetable per image).

Number of classes: 156 (fruits, vegetables and nuts).
